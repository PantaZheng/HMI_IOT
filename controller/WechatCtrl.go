...
func Menu(){
	...
	btnEnroll.SetAsViewButton("个人信息","https://open.weixin.qq.com/connect/oauth2/authorize?appid="+service.WeChatAppId+"&redirect_uri="+service.ServerAddress+"/create&response_type=code&scope=snsapi_base&state=12#wechat_redirect")
