...
func New() *gorm.DB {
	...
	connect := mysqlConfig.UserName + ":" + mysqlConfig.Password + "@/" + mysqlConfig.DBName + "?charset" + mysqlConfig.Charset + "&collation=" + mysqlConfig.Collation + "&parseTime=True&loc=Local"
