...
){return p}),n.d(t,"normalize",function(){return T}),n.d(t,"opacify",function(){return Le}),n.d(t,"padding",function(){return st}),n.d(t,"parseToHsl",function(){return $}),n.d(t,"parseToRgb",function(){return Q}),n.d(t,"placeholder",function(){return _}),n.d(t,"position",function(){return ut}),n.d(t,"radialGradient",function(){return P}),n.d(t,"readableColor",function(){return Re}),n.d(t,"rem",function(){return h}),n.d(t,"retinaImage",function(){return I}),n.d(t,"rgb",function(){return le}),n.d(t,"rgba",
function(){return se}),n.d(t,"saturate",function(){return Ae}),n.d(t,"selection",function(){return N}),n.d(t,"setHue",function(){return De}),n.d(t,"setLightness",function(){return Fe}),n.d(t,"setSaturation",function(){return We}),n.d(t,"shade",function(){return ze}),n.d(t,"size",function(){return dt}),n.d(t,"stripUnit",function(){return l}),n.d(t,"textInputs",function(){return ht}),n.d(t,"timingFunctions",function(){return R}),n.d(t,"tint",function(){return He}),n.d(t,"toColorString",function(){return he}),
...
return void 0===t&&(t=""),(n={})[t+"::-moz-selection"]=m({},e),n[t+"::selection"]=m({},e),n}var L={easeInBack:"cubic-bezier(0.600, -0.280, 0.735, 0.045)",easeInCirc:"cubic-bezier(0.600,  0.040, 0.980, 0.335)",easeInCubic:"cubic-bezier(0.550,  0.055, 0.675, 0.190)",easeInExpo:"cubic-bezier(0.950,  0.050, 0.795, 0.035)",easeInQuad:"cubic-bezier(0.550,  0.085, 0.680, 0.530)",easeInQuart:"cubic-bezier(0.895,  0.030, 0.685, 0.220)",easeInQuint:"cubic-bezier(0.755,  0.050, 0.855, 0.060)",
...
function R(e){return function(e){return L[e]}(e)}function j(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return se(m({},n,{alpha:be(0,1,(100*("number"==typeof n.alpha?n.alpha:1)+100*parseFloat(e))/100)}))}var Le=me(Ne)
function Re(e){return.179<Ce(e)?"#000":"#fff"}function je(e,t){var n=$(t)
...
var S=a(n("o0o1")),v=a(n("yXPU")),g=a(n("MVZn")),y=n("Saem"),w=n("Clcl"),E=n("RrAf"),f=n("qYFl"),k=window.MB
t.createWorkspacePusher=function(e){var t,n,a=e.filterStaleData,b=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:[],o=p(),t=e.reduce(function(e,t){var n=t.object,a=n.cid,r=n.mtime,i=void 0===r?o:r
return e[a]=i,e},{})
return a(t)},r=(0,g.default)({},E.initialSocketState,{userId:k.user.id,projectCidList:[]}),i={"broadcast:user:data":function(e){e.type
...
C(n,u,c,d)}}catch(e){r=!0,i=e}finally{try{a||null==l.return||l.return()}finally{if(r)throw i}}},"broadcast:upgrade-notice:new":function(e){e.type
...
"free"===t&&"pro"==n||"pro"===t&&"free"==n||k.action("entry:update:upgrade-notice-indicator-status",{status:"TWINKLE"})}},o={"broadcast:project:data":(n=(0,v.default)(S.default.mark(function e(t){var n,a,r,i,o,l,s,c,u,d,f,p,h
...
break}return u=c.value,d=u.action,f=u.className,p=u.object,h=u.extraInfo,e.next=12,x(r,f,d,p,h)
...
case 29:case"end":return e.stop()}},e,null,[[6,17,21,29],[22,,24,28]])})),function(e){return n.apply(this,arguments)}),"broadcast:project:batch-save":(t=(0,v.default)(S.default.mark(function e(t){var n,a,r,i,o,l,s,c,u,d,f,p,h,m,v,g,y
...
break}return h=p.value,m=h.className,v=h.action,g=h.object,y=h.extraInfo,e.next=13,x(s,m,v,g,y,r,a)
...
case 30:case"end":return e.stop()}},e,null,[[7,18,22,30],[23,,25,29]])})),function(e){return t.apply(this,arguments)})},l=(0,E.createSocketStore)({initialState:r,socketPayloadListenerMap:i,socketPayloadQueueAsyncListenerMap:o}),s=l.getState,c=l.setState,u=l.addEventListener,d=l.removeEventListener,f=l.getIsSocketConnected,p=l.getSocketTimestamp,h=l.sendSocketPayloadAsync
u("socket:open",function(){var e=s().projectCidList
e.length&&h("join:projects",{projectCidList:e}).catch(w.REPORT_ERROR)})
var m=function(){var t=(0,v.default)(S.default.mark(function e(t){var n,a
return S.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=s(),a=n.projectCidList,e.abrupt("return",!a.includes(t)&&h("join:projects",{projectCidList:[t]}).then(function(e){c({projectCidList:(0,y.arrayMatchPush)(a,t)})},w.REPORT_ERROR))
case 2:case"end":return e.stop()}},e)}))
return function(e){return t.apply(this,arguments)}}()
return{addEventListener:u,removeEventListener:d,getIsSocketConnected:f,getSocketTimestamp:p,joinProject:m,leaveProject:function(t){var n=s().projectCidList
return n.includes(t)&&h("leave:projects",{projectCidList:[t]}).then(function(e){c({projectCidList:(0,y.arrayMatchDelete)(n,t)})},w.REPORT_ERROR)},requestBatchSave:function(e){var t=e.batchSaveQueue,n=void 0===t?[]:t,a=e.rootProjectCid,r=void 0===a?"":a,i=e.fromUser
return h("request:project:batch-save",{batchSaveQueue:n,rootProjectCid:r,fromUser:void 0===i?{}:i})},enableSocketChannel:m,resetSocketChannel:function(){var e=s().projectCidList
return h("leave:projects",{projectCidList:e}).then(function(e){c({projectCidList:[]})},w.REPORT_ERROR)}}}
var C=function(e,t,n,a){e.has(a.cid)||(0,f.isRemoteMtimeStale)(t,a.cid,a.mtime)||("Team"===t?(0,f.updateTeam)(n,a):"Project"===t?(0,f.updateProject)(n,a):"Collaborator"===t&&(0,f.updateCollaborator)(n,a))},x=function(){var o=(0,v.default)(S.default.mark(function e(t,n,a,r,i,o){var l,s,c,u,d=arguments
...
e.next=5
break
case 5:if("PointComments::Comment"===n||"Comment"===n)return e.abrupt("return",k.webpackInterface&&k.webpackInterface.pushData("comments",a,r))
e.next=7
break
case 7:if("PointComments::Thread"===n||"CommentThread"===n)return e.abrupt("return",k.webpackInterface&&k.webpackInterface.pushData("comment-threads",a,r))
e.next=9
break
case 9:if(k.f.inSharing||!k.currentProject)return e.abrupt("return")
e.next=11
break
case 11:if(e.t0=f.updateWorkspaceMap[n],e.t0)return e.next=15,f.updateWorkspaceMap[n](a,r,i)
e.next=15
break
case 15:l.id&&(!(s="Screen"===n?r.cid:r.screen_cid)&&r.screenstate_cid&&(c=Screenstate.find(r.screenstate_cid))&&(s=c.screen_cid),(u=CoWorker.find(l.id)||new CoWorker({cid:l.id,name:l.name,avatar:l.avatar})).screen_cid=s,u.last_seen=new Date,u.save(),k.renderCoWorkers&&k.renderCoWorkers())
...
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var L=r(n("J4zp")),i=r(n("lwsE")),o=r(n("W8MJ")),l=r(n("a1gu")),s=r(n("Nsbk")),c=r(n("PJYZ")),u=r(n("7W2i")),d=r(n("lSNA")),f=r(n("17x9")),R=a(n("q1tI")),j=r(n("DKAG")),A=r(n("foKU")),B=r(n("tBsX")),D=n("oose"),O=r(n("dYO+")),F=r(n("DdUa")),q=r(n("kJQk")),W=r(n("9ZUU")),U=r(n("TSYQ"))
n("fSKh")
...
m=n.x,v=n.y,g="landscape"===r.orientation,y=c||u,b=y||!l?"none":s,S=a.width,w=a.height,E=g?[w,S]:[S,w],k=(0,L.default)(E,2),C=k[0],x=k[1],T={width:C,height:x,minWidth:C,minHeight:x,transform:"matrix(1, 0, 0, 1, ".concat(m,", ").concat(v,")")},_={transform:"scale(".concat(t/100,")")},M={width:"".concat(t,"%"),height:"".concat(t,"%")},P={width:r.width*t/100,height:r.height*t/100},I=(0,U.default)({"wait-drag":i||h,"is-immersive":y,"is-layer-active":c,"is-screen-expanded":y||!l}),N=(0,U.default)("ui-layers",{
"is-shadow":!("default"===b&&p),"is-active":c})
return R.default.createElement(A.default,{x:m,y:v,scale:t,id:"simulator-container",className:I,isDisabled:h,onMouseDown:this.handleMouseDown,onScaleChange:this.handleScaleChange,onOffsetChange:this.handleOffsetChange},function(e,t,n){return R.default.createElement("div",{key:"1",className:(0,U.default)("screen-viewport",{"is-fullscreen":f,"is-geely":"car_play"===a.model}),style:T},R.default.createElement("div",{className:"zoom-area",style:_},R.default.createElement(F.default,null),
!y&&R.default.createElement(O.default,{project:a,shellType:b,isLandscape:g}),o&&R.default.createElement(W.default,null)),R.default.createElement("div",{className:"no-zoom-area-wrapper",style:M},R.default.createElement("div",{className:"no-zoom-area",style:p&&l?{}:P},R.default.createElement("div",{id:"ui-layers",className:N},d&&R.default.createElement(q.default,null),c&&!d&&R.default.createElement(B.default,null)),R.default.createElement("div",{id:"ui-comment-marker-panel"},R.default.createElement(
D.CommentMarkerPanelContainer,{isActive:u,scale:n/100})))))},R.default.createElement(j.default,{target:document,onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp}))}}]),t}(R.PureComponent);(t.default=p).propTypes={scale:f.default.number,canvasOffset:f.default.object,screen:f.default.object,project:f.default.object,shellType:f.default.string,isStickyShow:f.default.bool,isScrollable:f.default.bool,isLayerPreview:f.default.bool,isSpaceDown:f.default.bool,isLayerActive:f.default.bool,
...
return l.default.createElement(f.Tooltip,{content:{hover:n},duration:1e3},l.default.createElement(c.Dropdown,{opener:l.default.createElement(d.default,{type:"dora",name:a}),onSelect:t,menuClassName:r,menuList:[n],menuX:"right",arrowed:!0}))}
...
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var s=r(n("o0o1")),i=r(n("yXPU")),o=r(n("lwsE")),l=r(n("W8MJ")),c=r(n("a1gu")),u=r(n("Nsbk")),d=r(n("PJYZ")),f=r(n("7W2i")),p=r(n("lSNA")),m=a(n("q1tI")),h=r(n("17x9")),v=n("6XO9"),g=n("DqDi"),y=n("i6OX"),b=r(n("4QcC")),S=r(n("Ur7v")),w=r(n("lCKy")),E=r(n("iX79")),k=n("/5+U"),C=n("1iCU"),x=n("t3Un"),T=n("2EV6"),_=n("Gbs1"),M=n("6x+O"),P=n("/5+U"),I=r(n("rtgd")),N=r(n("UbMB")).default.bind(I.default),L=[{label:I18N.preview.preview,icon:m.default.createElement(y.SVGIcon,{name:"design/preview"})},{
label:I18N.preview_panel.developer_mode,icon:m.default.createElement(y.SVGIcon,{name:"design/inspect"})},{label:I18N.preview_panel.comment,icon:m.default.createElement(y.SVGIcon,{name:"design/comment"})}],R=L.slice(0,2),j=function(e){function i(){var e,a;(0,o.default)(this,i)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
...
,F(l,a,r)),T=s&&(0,D.default)({},q[r].opacity,F(s,a,r)),_=c&&(0,D.default)({},q[r].borderRadius,F(c,a,r)),M=f&&(0,D.default)({},q[r].backgroundColor,F(f,a,r,!0)),P=p&&(0,D.default)({},q[r].color,F(p,a,r,!0)),I=h&&(0,D.default)({},q[r].fontSize,F(h,a,r)),N=m&&(0,D.default)({},q[r].fontFamily,F(m,a,r)),L=v&&(0,D.default)({},q[r].fontStyle,F(v,a,r)),R=g&&(0,D.default)({},q[r].shadows,g),j=u&&(0,D.default)({},q[r].borderWidth,F(u,a,r)),A=d&&(0,D.default)({},q[r].borderColor,F(d,a,r,!0)),B=y&&(0,D.default)({},
q[r].textAlign,y)
return Object.assign({},w,E,k,C,x,T,_,j,A,M,P,I,L,B,R,N)}
...
var a=n("284h"),r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(n("PJYZ")),o=r(n("lSNA")),l=r(n("lwsE")),s=r(n("W8MJ")),c=r(n("a1gu")),u=r(n("Nsbk")),d=r(n("7W2i")),y=a(n("q1tI")),f=r(n("17x9")),p=n("vOnD"),h=r(n("i6OX")),b=n("wYtL"),m=r(n("QdB0")),S=r(n("5Mi5")),w=r(n("ULaQ")),E=r(n("Aa0X")),k=r(n("18l9")),C=r(n("jZq5")),x=r(n("DJvY")),T=r(n("DdUa")),_=r(n("2AqR")),M=r(n("nQhf")),P=r(n("xUDz")),I=r(n("NyBV")),N=r(n("ewu5")),L=r(n("mdx/")),v=r(n("gY5R")),R=n("1iCU"),g=r(n("XpKX")),j=r(n("UbMB")),A=n("/5+U"),B=j.default.bind(g.default),D=window,O=D.MB,F=D.I18N,
...
return a.has("inspect")?e.dispatch({type:"entry:preview:select",payload:{toolbarActiveItem:R.INSPECT}}):a.has("comment")?e.dispatch({type:"entry:preview:select",payload:{toolbarActiveItem:R.COMMENT}}):e.dispatch({type:"reducer:preview-toolbar:active-item:init"}),t}return(0,d.default)(r,e),(0,s.default)(r,[{key:"componentWillUnmount",value:function(){this.props.dispatch({type:"entry:preview:clear"})}},{key:"componentDidMount",value:function(){var e=(0,m.default)()
...
var c=n.owner_email,u=n.master,d=a.toolbarActiveItem,f=a.isFullScreenMode,p=d==R.PREVIEW,h=d==R.INSPECT,m=!O.isElectron()&&!O.isHTMLZip()&&h&&s&&H(),v=!u&&p&&(q.has(c)||r),g=B("mb-preview-page",{"is-offline-mode":O.isHTMLZip(),"is-uichina":O.isUIChina()||O.isForum(),"full-screen":f})
...
return m.default.createElement(y.Tooltip,{content:{click:a},type:"block",position:"top",arrowed:!1,className:_("download"),onClick:t},I18N.preview_panel.download,n?m.default.createElement(R,null):m.default.createElement(b.default,{type:"dora",name:"export",className:_("icon-download")}))}
N.propTypes={onClick:h.default.func,isLoading:h.default.bool,isLogin:h.default.bool}
var L=function(){return m.default.createElement("div",{className:_("layer-load")},m.default.createElement("span",{className:_("spinner")}))},R=function(){return m.default.createElement("div",{className:_("download-slice-load")},m.default.createElement(L,null))},j=function(){return m.default.createElement("div",{className:_("slice-load-wrap")},m.default.createElement(L,null))},A=function(){return m.default.createElement("div",{className:_("no-slice")},m.default.createElement("img",{
...
Me=(0,Ae.transfromProptype)({attr:(0,Le.default)({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:O,opacity:_e,borderRadius:ge},Te),language:m,unit:n}),Pe=ne?"ImageView":ae?"TextView":"View",Ie="screen"===t.type||t.kind?t.name:N,Ne="line"===t.name
return r?Re.default.createElement(Re.default.Fragment,null,Re.default.createElement(De.LayerName,{title:I18N.preview_panel.screen_name,value:Ie}),Re.default.createElement(De.GlobalAttributes,{adapterWidth:me,adapterHeight:ve,documentColor:f,globalText:u,globalColor:s,screenColor:h,userPickColor:o,colorUnit:v,dispatch:g})):Re.default.createElement("div",null,Re.default.createElement(De.LayerName,{value:Ie}),Re.default.createElement(De.BasicAttributes,{adapterTop:pe,adapterLeft:he,adapterWidth:me,
adapterHeight:ve,rotate:be,radius:ge,opacity:ye,unit:n,colorUnit:v}),ae&&Re.default.createElement(De.TextLayerInfo,{textStyles:D,alignment:O,vertical_alignment:F,lineHeight:Ee,letterSpacing:ke,ratio:a,unit:n,o:t.o,padding:R,fontStyle:Ce,colorUnit:v,hiddSpacing:A,text:(0,je.getTextContent)(t)}),te&&Re.default.createElement(De.Fills,{backgroundColorSort:_,colorUnit:v}),ee&&Re.default.createElement(De.BorderInfo,{isStroke:Ne,borderSort:P,ratio:a,unit:n,colorUnit:v}),re&&Re.default.createElement(De.Shadows,{
shadows:H,textShadows:K,colorUnit:v,unit:n,ratio:a}),ie&&Re.default.createElement(De.Shadows,{shadows:X,colorUnit:v,unit:n,ratio:a,isInnerShaow:!0}),oe&&Re.default.createElement(De.ImageInfo,{imageSetZip:z,name:t.display_name,imageSet:Q}),Re.default.createElement(De.CodeBox,{code:Me,whichAndView:Pe,language:m,text:(0,je.getTextContent)(t)||""}))}
...
//# sourceMappingURL=preview-7ed9f1615fe14a3814f8.js.map